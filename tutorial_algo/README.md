...
* マップのアドレスとインデックスについて  
	__マップのアドレス番号__  
	<img width="206" alt="mapのアドレス" src="https://github.com/oomori-kun/toiodo_maz/assets/17058514/78ac1c94-4f9a-4cf3-8245-eb92eeb9a7a7">  
	マップの番号がアドレスになります。また、アドレスは、灰色音部分の行番号と列番号で指定できます。その場合、本教材ではインデックスと読んでいます。
...
1. __最も基本的な技法を知ろう__	
	...
	1. __経路上の最大値を探そう　その1__  
		[経路上の最大値を探そう　その1](https://toio.github.io/toio-visual-programming/beta/?project=https://github.com/oomori-kun/toiodo_maz/blob/main/tutorial_algo/sb3/toiodo_maz_S2_1_1_12.sb3)  
		スタート位置から右に移動して、経路上の最大値を探そう
		ヒント：最初の数字を仮の最大値とします。その後、経路上の数値がなくなるまで次を繰り返します。toioを移動して数値を読み、仮の最大値と比較して、いま読んだ数字が小さければ、それを仮の最大値とします。

	1. __経路上の最大値を探そう　その2__  
		[経路上の最大値を探そう　その2](https://toio.github.io/toio-visual-programming/beta/?project=https://github.com/oomori-kun/toiodo_maz/blob/main/tutorial_algo/sb3/toiodo_maz_S2_1_1_13.sb3)  
		スタート位置から右に移動して、アドレス番号0から6の7つの数字の中にある最大値を探そう
		ヒント：  アドレス番号0から6の7つの数字を順番に、仮の最大値と繰り返し比較して、比較したアドレスの値とくらべて仮の最大値の方が大きければ、アドレスの値を仮の最大値とする。すべての数字と比較した時の仮の最大値を、最終的に最大値とする。  
